...
import br.com.gumga.thingcollection.application.service.AcessoryService;
...
public class AcessoryAPI extends GumgaAPI<Acessory, Long> {


    @Autowired
    public AcessoryAPI(GumgaService<Acessory, Long> service) {
        super(service);
    }
