...
import br.com.gumga.thingcollection.application.service.ReservationService;
...
public class ReservationAPI extends GumgaAPI<Reservation, Long> {


    @Autowired
    public ReservationAPI(GumgaService<Reservation, Long> service) {
        super(service);
    }
