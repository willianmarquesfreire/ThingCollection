...
import br.com.gumga.thingcollection.application.service.ContactService;
...
public class ContactAPI extends GumgaAPI<Contact, Long> {


    @Autowired
    public ContactAPI(GumgaService<Contact, Long> service) {
        super(service);
    }
