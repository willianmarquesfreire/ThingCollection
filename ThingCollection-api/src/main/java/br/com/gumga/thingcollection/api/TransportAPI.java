...
import br.com.gumga.thingcollection.application.service.TransportService;
...
public class TransportAPI extends GumgaAPI<Transport, Long> {


    @Autowired
    public TransportAPI(GumgaService<Transport, Long> service) {
        super(service);
    }
