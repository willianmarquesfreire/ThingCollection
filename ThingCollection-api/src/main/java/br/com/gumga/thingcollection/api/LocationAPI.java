...
import br.com.gumga.thingcollection.application.service.LocationService;
...
public class LocationAPI extends GumgaAPI<Location, Long> {


    @Autowired
    public LocationAPI(GumgaService<Location, Long> service) {
        super(service);
    }
