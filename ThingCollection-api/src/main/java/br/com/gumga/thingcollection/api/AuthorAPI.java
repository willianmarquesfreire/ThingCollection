...
import br.com.gumga.thingcollection.application.service.AuthorService;
...
public class AuthorAPI extends GumgaAPI<Author, Long> {


    @Autowired
    public AuthorAPI(GumgaService<Author, Long> service) {
        super(service);
    }
