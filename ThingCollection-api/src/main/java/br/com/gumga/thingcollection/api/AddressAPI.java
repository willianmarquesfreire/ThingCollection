...
import br.com.gumga.thingcollection.application.service.AddressService;
...
public class AddressAPI extends GumgaAPI<Address, Long> {


    @Autowired
    public AddressAPI(GumgaService<Address, Long> service) {
        super(service);
    }
