...
import br.com.gumga.thingcollection.application.service.SubjectService;
...
public class SubjectAPI extends GumgaAPI<Subject, Long> {


    @Autowired
    public SubjectAPI(GumgaService<Subject, Long> service) {
        super(service);
    }
