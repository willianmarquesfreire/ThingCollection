define([], function() {
  ...
  ModalAddressController.$inject = ['$scope', 'gumgaController', '$uibModal', '$uibModalInstance', 'gumgaController','entity'];

  function ModalAddressController($scope, gumgaController, $uibModal, $uibModalInstance, gumgaController, entity) {
  
  	   $scope.author = {};
  	   $scope.author.data = angular.copy(entity) || {};
